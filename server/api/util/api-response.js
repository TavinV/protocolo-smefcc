class ApiResponse {
    ...
    static CONFLICT(res, message = "Já existe um registro com essas informações", data = null) {
    ...
    static ACCEPTED(res, message = "Requisição aceita para processamento", data = null) {
